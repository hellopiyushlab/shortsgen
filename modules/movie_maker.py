...
def create_video(list_of_subtitles, audio_clip_path):
    # List of strings
    texts = list_of_subtitles 

    # List of audio file paths
    # audio_files = get_audio_files("audio-clips")
    audio_files = audio_clip_path  
    ...
    final_clip.write_videofile('static/output-videos/output_video.mp4', codec="h264_nvenc", fps=24) # codec libx264 for cpu, h264_nvenc for nvidia gpus